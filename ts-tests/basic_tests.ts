...
function getTransaction(apiName: any,
                        params: any,
                        txn: string,
                        prompts: any[]) {
  return async () => {
...
describe('Create Tx tests', function() {
  it("can build a simple transfer tx",
     getTransaction(
       "signTransferTx",
       {
         path: "0/0",
  ...
  it("can build a transfer-create tx",
     getTransaction(
       ...
       [
         { "header": "Transfer", "prompt": "23.67 from k:ffd8cd79deb956fa3c7d9be0f836f20ac84b140168a087a842be4760e40e2b1c to 83934c0f9b005f378ba3520f9dea952fb0a90e5aa36f1b5ff837d9b30c471790 on network testnet04" },
         { "header": "Paying Gas", "prompt": "at most 2300 at price 1.0e-6" },
         {"text": "Sign Transaction?", "x": 19, "y": 11,},
         {"text": "Confirm", "x": 43, "y": 11,}
       ]
  ...
  it("can build a cross-chain transfer tx",
     getTransaction(
       ...
       [
         { "header": "Transfer", "prompt": "Cross-chain 23.67 from k:ffd8cd79deb956fa3c7d9be0f836f20ac84b140168a087a842be4760e40e2b1c to 83934c0f9b005f378ba3520f9dea952fb0a90e5aa36f1b5ff837d9b30c471790 to chain 2 on network testnet04" },
         { "header": "Paying Gas", "prompt": "at most 2300 at price 1.0e-6" },
         {"text": "Sign Transaction?", "x": 19, "y": 11,},
         {"text": "Confirm", "x": 43, "y": 11,}
       ]
